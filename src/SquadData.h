...
public:
    ...
    bool            canAssignUnitToSquad(CCUnit unit, const Squad & squad) const;
    void            assignUnitToSquad(CCUnit unit, Squad & squad);
    ...
    bool            unitIsInSquad(CCUnit unit) const;
    const Squad *   getUnitSquad(CCUnit unit) const;
    Squad *         getUnitSquad(CCUnit unit);
